...
public class UpdateEmployee extends JFrame implements ActionListener {
    ...
    JTextField teducation, tfname, tdob, taddress, tphone, taadhar, temail, tsalary, tdesignation;
    JLabel tempid;
    JButton add, back;
    String number;
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == add) {
            ...
            try {
                ...
                String query = "update employee set fname='"+fname+"',address='"+address+"',phone='"+phone+"',email='"+email+"',education='"+education+"',designation='"+designation+"'where empID = '"+number+"'";
